...
const oas = fs.readFileSync(path.join(__dirname, '/../packages/api-explorer-ui/__tests__/fixtures/multiple-schemes/circular-oas.json'), 'utf8'); const createDocs = require('../packages/api-explorer-ui/lib/create-docs');
